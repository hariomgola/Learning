const exportData = {
  ...
  "CSS Advance Selector": cssAdvanceSelector,
  "CSS Visual Rules": visualRules,
  "Box Model": boxModel,
  "Change Box Model": changingboxModel,
  "Display and Positioning": displayandPositioning,
};
...
# Combine multiple selector
 h1,h2,p,a{
  font-family: sans-sarif
 }
 - In above example the font family property will be assigned to all the above mentioned selector.
`;
